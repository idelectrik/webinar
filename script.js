            ...
            910: (e, t, o) => {
                ...
                async function p() {
                    return void 0 === c && (c = async function() {
                        return function(e) {
                            const t = new Map;
                            return u(e.layers, "", t), t
                        }(await WA.room.getTiledMap())
                    }()), c
                }

                function u(e, t, o) {
                    for (const n of e) "group" === n.type ? u(n.layers, t + n.name + "/", o) : (n.name = t + n.name, o.set(n.name, n))
                }
                ...
                function h(e) {
                    ...
                    for (let a = 0; a < e.height; a++)
                        for (let s = 0; s < e.width; s++) 0 !== i[s + a * e.width] && (t = Math.min(t, s), r = Math.max(r, s), o = Math.min(o, a), n = Math.max(n, a));
                    return {
                        top: o,
                        left: t,
                        right: r + 1,
                ...
                E.prototype.eos = function() {
                    ...
                    if (r.hasOwnProperty(e)) t = r[e];
                        ...
                        for (var i, a, s, l = this, c = !1; l;) {
                            if (e.indexOf(".") > 0)
                                for (i = l.view, a = e.split("."), s = 0; null != i && s < a.length;) s === a.length - 1 && (c = w(i, a[s]) || (o = i, n = a[s], null != o && "object" != typeof o && o.hasOwnProperty && o.hasOwnProperty(n))), i = i[a[s++]];
                            else i = l.view[e], c = w(l.view, e);
                            if (c) {
                                t = i;
                                break
                            }
                    ...
                    return null == i && (i = function(e, t) {
                        ...
                        y(t || k.tags);
                        for (var w, A, T, L, P, M, V = new E(e); !V.eos();) {
                            if (w = V.pos, T = V.scanUntil(o))
                                for (var U = 0, j = T.length; U < j; ++U) i = L = T.charAt(U),
                                    function(e, t) {
                                        return v.call(e, t)
                                    }(b, i) ? (u = !0, a = !0, h += " ") : (c.push(l.length), h += L), l.push(["text", L, w, w + 1]), w += 1, "\n" === L && (f(), h = "", g = 0, a = !1);
                            if (!V.scan(o)) break;
                            if (p = !0, A = V.scan(B) || "name", V.scan(W), "=" === A ? (T = V.scanUntil(x), V.scan(x), V.scanUntil(n)) : "{" === A ? (T = V.scanUntil(r), V.scan(C), V.scanUntil(n), A = "&") : T = V.scanUntil(n), !V.scan(n)) throw new Error("Unclosed tag at " + V.pos);
                            if (P = ">" == A ? [A, T, w, V.pos, h, g, a] : [A, T, w, V.pos], g++, l.push(P), "#" === A || "^" === A) s.push(P);
                            else if ("/" === A) {
                                if (!(M = s.pop())) throw new Error('Unopened section "' + T + '" at ' + w);
                                if (M[1] !== T) throw new Error('Unclosed section "' + M[1] + '" at ' + w)
                            } else "name" === A || "{" === A || "&" === A ? u = !0 : "=" === A && y(T)
                        }
                        if (f(), M = s.pop()) throw new Error('Unclosed section "' + M[1] + '" at ' + V.pos);
                        return function(e) {
                            for (var t, o = [], n = o, r = [], i = 0, a = e.length; i < a; ++i) switch ((t = e[i])[0]) {
                                case "#":
                                case "^":
                    ...
                    var r = this.getConfigTags(n),
                        i = this.parse(e, r),
                        a = t instanceof T ? t : new T(t, void 0);
                    return this.renderTokens(i, a, o, e, n)
                }, L.prototype.renderTokens = function(e, t, o, n, r) {
                    for (var i, a, s, l = "", c = 0, p = e.length; c < p; ++c) s = void 0, "#" === (a = (i = e[c])[0]) ? s = this.renderSection(i, t, o, n, r) : "^" === a ? s = this.renderInverted(i, t, o, n, r) : ">" === a ? s = this.renderPartial(i, t, o, r) : "&" === a ? s = this.unescapedValue(i, t) : "name" === a ? s = this.escapedValue(i, t, r) : "text" === a && (s = this.rawValue(i)), void 0 !== s && (l += s);
                    return l
                    ...
                    if (s) {
                        if (d(s))
                            for (var l = 0, c = s.length; l < c; ++l) a += this.renderTokens(e[4], t.push(s[l]), o, n, r);
                        else if ("object" == typeof s || "string" == typeof s || "number" == typeof s) a += this.renderTokens(e[4], t.push(s), o, n, r);
                        else if (y(s)) {
                            if ("string" != typeof n) throw new Error("Cannot use higher-order sections without the original template");
                            null != (s = s.call(t.view, n.slice(e[3], e[5]), (function(e) {
                                return i.render(e, t, o, r)
                            }))) && (a += s)
                        } else a += this.renderTokens(e[4], t, o, n, r);
                        return a
                    }
                    ...
                    if (o) {
                        ...
                        if (null != i) {
                            var a = e[6],
                                ...
                                l = e[4],
                                c = i;
                            0 == s && l && (c = this.indentPartial(i, l, a));
                    ...
                    var n = this.getConfigEscape(o) || k.escape,
                        r = t.lookup(e[1]);
                    if (null != r) return "number" == typeof r && n === k.escape ? String(r) : n(r)
                ...
                k.clearCache = function() {
                    ...
                    var r;
                    return P.render(e, t, o, n)
                }, k.escape = function(e) {
                    return String(e).replace(/[&<>"'`=\/]/g, (function(e) {
                        return A[e]
                    }))
                }, k.Scanner = E, k.Context = T, k.Writer = L;
                const M = k;
                class V {
                    constructor(e, t) {
                ...
                function H(e) {
                    WA.state.onVariableChange(e.name).subscribe((() => {
                        WA.state[e.name] ? function(e) {
                            ...
                            let n = 1;
                            if (o) {
                                const t = D(e.properties.mustGetString("openLayer").split("\n"));
                                if (t > o) return;
                                n = 1 - t / o
                            }
                            ...
                            let n = 1;
                            if (o) {
                                const t = D(e.properties.mustGetString("closeLayer").split("\n"));
                                if (t > o) return;
                                n = 1 - t / o
                            }
                            t && WA.sound.loadSound(t).play({
                ...
                function Z(e, t, o, n) {
                    ...
                    WA.room.onEnterLayer(r).subscribe((() => {
                        s = !0, o.getBoolean("autoOpen") && c ? WA.state[t.name] = !0 : WA.state[t.name] || (!p || c) && p || !o.getString("code") && !o.getString("codeVariable") ? c && (WA.state[t.name] ? u() : h()) : function(e) {
                        ...
                        s = !1, o.getBoolean("autoClose") && (WA.state[t.name] = !1), i && i.remove(), f()
                    })), WA.state.onVariableChange(t.name).subscribe((() => {
                        s && (o.getBoolean("autoClose") || !0 !== WA.state[t.name] || u(), a && !0 === WA.state[t.name] && f(), o.getBoolean("autoOpen") || !1 !== WA.state[t.name] || h())
                    }))
                }
                ...
                async function $(e) {
                    ...
                    const t = await s();
                    G = await p();
                    for (const e of t.values()) e.properties.get("door") && H(e), e.properties.get("bell") && z(e);
                    for (const o of G.values()) {
                        ...
                        const a = r.getString("bellVariable");
                        a && q(a, r, o.name)
                    }
                ...
                function X() {
                    return WA.onInit().then((() => {
                        $().catch((e => console.error(e))), async function() {
                            const e = await p();
                            for (const t of e.values()) F(new n(t.properties), t.name)
                        }().catch((e => console.error(e))), async function(e) {
                            const t = await WA.room.getTiledMap();
                            e = null != e ? e : r, O = await p();
                                ...
                                const n = await WA.room.website.get("tutorial"),
                                    i = () => {
                                        const o = t.x + n.x + n.width > e.x + e.width,
                                            ...
                                            a = t.y + n.y < e.y;
                                        o ? n.x = -n.width - 24 : r && (n.x = 24), i ? n.y = -n.height : a && (n.y = 16)
                                    },
                                    a = e => {
